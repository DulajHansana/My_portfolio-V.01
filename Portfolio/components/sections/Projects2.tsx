												...
												<div className="p-lg-5 p-md-4 p-3 border border-1 mt-5 bg-3">
													<div className="row">
                                                        ...
                                                        <div className="col-lg-5">
                                                            ...
                                                            >
                                                                <SwiperSlide>
                                                                    <img className="w-100" src="assets/imgs/home-page-2/projects/18.jpeg" alt="Project Image 1" />
                                                                </SwiperSlide>
                                                                <SwiperSlide>
                                                                    <img className="w-100" src="assets/imgs/home-page-2/projects/19.jpeg" alt="Project Image 2" />
                                                                </SwiperSlide>
                                                                <SwiperSlide>
                                                                    <img className="w-100" src="assets/imgs/home-page-2/projects/12.jpeg" alt="Project Image 3" />
                                                                </SwiperSlide>
																<SwiperSlide>
                                                                    <img className="w-100" src="assets/imgs/home-page-2/projects/16.jpeg" alt="Project Image 3" />
                                                                </SwiperSlide>
