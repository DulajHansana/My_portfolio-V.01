													...
													<div className="row">
                                                        ...
                                                        <div className="col-lg-5">
                                                            ...
                                                            >
																...
																<SwiperSlide>
                                                                    <img className="w-100" src="assets/imgs/home-page-2/projects/33.jfif" alt="Project Image 1" />
                                                                </SwiperSlide>	
																<SwiperSlide>
                                                                    <img className="w-100" src="assets/imgs/home-page-2/projects/34.jfif" alt="Project Image 1" />
                                                                </SwiperSlide>	
																<SwiperSlide>
												...
												<div className="p-lg-5 p-md-4 p-3 border border-1 mt-5 bg-3">
													<div className="row">
                                                        ...
                                                        <div className="col-lg-5">
                                                            ...
                                                            >
                                                                <SwiperSlide>
                                                                    <img className="w-100" src="assets/imgs/home-page-2/projects/28.png" alt="Project Image 1" />
                                                                </SwiperSlide>
																<SwiperSlide>
                                                                    <img className="w-100" src="assets/imgs/home-page-2/projects/29.png" alt="Project Image 1" />
                                                                </SwiperSlide>					
                                                            </Swiper>
                                                            <div className="swiper-button-prev-project shadow position-relative"></div>
                                                            <div className="swiper-button-next-project shadow position-relative"></div>
														...
														<div className="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
															...
															<ul className="mt-4 list-unstyled">
																...
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		<p className="text-dark mb-0 text-end">Client</p>
																		<p className="text-300 mb-0 text-end">WSO2</p>
																	</div>
																</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																...
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		<p className="text-dark mb-0 text-end">Technologies</p>
																		<p className="text-300 mb-0 text-end">React, Next.js, Ballerina, WebSockets, MongoDB, Docker</p>
																	</div>
																</li>
															</ul>
															<div className="d-flex flex-wrap align-items-center gap-3 mt-7">
																<Link href="https://www.figma.com/design/6zcJyzKWBBeMpBRq4PAxDr/chat-app?node-id=0-1&t=EPHGEBj8piN1qR78-1" className="text-300 border-bottom border-1 px-2 pb-2 link-hover">
																	<svg xmlns="http://www.w3.org/2000/svg" width={13} height={13} viewBox="0 0 13 13" fill="none">
																		<path d="M11.0037 3.91421L2.39712 12.5208L0.98291 11.1066L9.5895 2.5H2.00373V0.5H13.0037V11.5H11.0037V3.91421Z" fill="#8F8F92" />
																	</svg>
																	Live Demo UI
																</Link>
																<Link href="https://github.com/DulajHansana/Spark-Chat-V.0.1.git" className="text-300 border-bottom border-1 px-2 pb-2 link-hover">
																	<svg xmlns="http://www.w3.org/2000/svg" width={24} height={25} viewBox="0 0 24 25" fill="none">
																		<path d="M12.001 2.5C6.47598 2.5 2.00098 6.975 2.00098 12.5C2.00098 16.925 4.86348 20.6625 8.83848 21.9875C9.33848 22.075 9.52598 21.775 9.52598 21.5125C9.52598 21.275 9.51348 20.4875 9.51348 19.65C7.00098 20.1125 6.35098 19.0375 6.15098 18.475C6.03848 18.1875 5.55098 17.3 5.12598 17.0625C4.77598 16.875 4.27598 16.4125 5.11348 16.4C5.90098 16.3875 6.46348 17.125 6.65098 17.425C7.55098 18.9375 8.98848 18.5125 9.56348 18.25C9.65098 17.6 9.91348 17.1625 10.201 16.9125C7.97598 16.6625 5.65098 15.8 5.65098 11.975C5.65098 10.8875 6.03848 9.9875 6.67598 9.2875C6.57598 9.0375 6.22598 8.0125 6.77598 6.6375C6.77598 6.6375 7.61348 6.375 9.52598 7.6625C10.326 7.4375 11.176 7.325 12.026 7.325C12.876 7.325 13.726 7.4375 14.526 7.6625C16.4385 6.3625 17.276 6.6375 17.276 6.6375C17.826 8.0125 17.476 9.0375 17.376 9.2875C18.0135 9.9875 18.401 10.875 18.401 11.975C18.401 15.8125 16.0635 16.6625 13.8385 16.9125C14.201 17.225 14.5135 17.825 14.5135 18.7625C14.5135 20.1 14.501 21.175 14.501 21.5125C14.501 21.775 14.6885 22.0875 15.1885 21.9875C19.259 20.6133 21.9999 16.7963 22.001 12.5C22.001 6.975 17.526 2.5 12.001 2.5Z" fill="#8F8F92" />
																	</svg>
																	View on Github
												...
												<div className="p-lg-5 p-md-4 p-3 border border-1 mt-5 bg-3">
													<div className="row">
                                                        ...
                                                        <div className="col-lg-5">
                                                            ...
                                                            >
                                                                <SwiperSlide>
                                                                    <img className="w-100" src="assets/imgs/home-page-2/projects/30.jfif" alt="Project Image 1" />
                                                                </SwiperSlide>
																<SwiperSlide>
                                                                    <img className="w-100" src="assets/imgs/home-page-2/projects/35.png" alt="Project Image 1" />
                                                                </SwiperSlide>					
                                                            </Swiper>
                                                            <div className="swiper-button-prev-project shadow position-relative"></div>
                                                            <div className="swiper-button-next-project shadow position-relative"></div>
														...
														<div className="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
															...
															<p>I have recently achieved a significant milestone in their career by successfully developing my first industrial website for SLPN Printers Company, now live at www.slpn.lk. This e-commerce platform was crafted using the WordPress, showcasing also I expertise in web development and I had ability to deliver professional-grade solutions.</p>
															<ul className="mt-4 list-unstyled">
																<li className="text-secondary-2 mb-3 border-bottom pb-3">Project Info</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		<p className="text-dark mb-0 text-end">Client</p>
																		<p className="text-300 mb-0 text-end">SLPN Printers</p>
																	</div>
																</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		<p className="text-dark mb-0 text-end">Completion Time</p>
																		<p className="text-300 mb-0 text-end">2 Month</p>
																	</div>
																</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		<p className="text-dark mb-0 text-end">Technologies</p>
																		<p className="text-300 mb-0 text-end">Wordpress, UX/UI</p>
																	</div>
																</li>
															</ul>
															<div className="d-flex flex-wrap align-items-center gap-3 mt-7">
																<Link href="https://slpn.lk/" className="text-300 border-bottom border-1 px-2 pb-2 link-hover">
																	<svg xmlns="http://www.w3.org/2000/svg" width={13} height={13} viewBox="0 0 13 13" fill="none">
																		<path d="M11.0037 3.91421L2.39712 12.5208L0.98291 11.1066L9.5895 2.5H2.00373V0.5H13.0037V11.5H11.0037V3.91421Z" fill="#8F8F92" />
																	</svg>
																	Live Demo
												...
												<div className="p-lg-5 p-md-4 p-3 border border-1 mt-5 bg-3">
													<div className="row">
                                                        ...
                                                        <div className="col-lg-5">
                                                            ...
                                                            >
                                                                <SwiperSlide>
                                                                    <img className="w-100" src="assets/imgs/home-page-2/projects/37.png" alt="Project Image 1" />
                                                                </SwiperSlide>
																<SwiperSlide>
                                                                    <img className="w-100" src="assets/imgs/home-page-2/projects/36.png" alt="Project Image 1" />
                                                                </SwiperSlide>
																<SwiperSlide>
                                                                    <img className="w-100" src="assets/imgs/home-page-2/projects/38.png" alt="Project Image 1" />
                                                                </SwiperSlide>					
                                                            </Swiper>
                                                            <div className="swiper-button-prev-project shadow position-relative"></div>
                                                            <div className="swiper-button-next-project shadow position-relative"></div>
														...
														<div className="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
															<h4 className="text-linear-4">
															CareerPulse Mobile Application
															</h4>
															<p>CareerPulse is a mobile application designed to simplify the internship search for students and recent graduates. By aggregating internship listings from diverse industries, CareerPulse provides users with personalized recommendations that align with their academic backgrounds and career aspirations.</p>
															<ul className="mt-4 list-unstyled">
																<li className="text-secondary-2 mb-3 border-bottom pb-3">Project Info</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																...
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		<p className="text-dark mb-0 text-end">Supervisor</p>
																		<p className="text-300 mb-0 text-end">Mr.Kavindu Chethiya </p>
																	</div>
																</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		<p className="text-dark mb-0 text-end">Completion Time</p>
																		<p className="text-300 mb-0 text-end">6 Month</p>
																	</div>
																</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		<p className="text-dark mb-0 text-end">Technologies</p>
																		<p className="text-300 mb-0 text-end">Flutter, Dart, Firebase, Docker</p>
																	</div>
																</li>
															</ul>
															<div className="d-flex flex-wrap align-items-center gap-3 mt-7">
																<Link href="https://www.figma.com/design/1RgmbAJPd7WaKACoZGhwmw/CareerPulse-UI-Design?node-id=0-1&t=0mrNGcX4YRMsWqBa-1" className="text-300 border-bottom border-1 px-2 pb-2 link-hover">
																	<svg xmlns="http://www.w3.org/2000/svg" width={13} height={13} viewBox="0 0 13 13" fill="none">
																		<path d="M11.0037 3.91421L2.39712 12.5208L0.98291 11.1066L9.5895 2.5H2.00373V0.5H13.0037V11.5H11.0037V3.91421Z" fill="#8F8F92" />
																	</svg>
																	Live Demo UI
																</Link>
																<Link href="https://github.com/DulajHansana/CareerPulse-Mobile-App.git" className="text-300 border-bottom border-1 px-2 pb-2 link-hover">
																	<svg xmlns="http://www.w3.org/2000/svg" width={24} height={25} viewBox="0 0 24 25" fill="none">
																		<path d="M12.001 2.5C6.47598 2.5 2.00098 6.975 2.00098 12.5C2.00098 16.925 4.86348 20.6625 8.83848 21.9875C9.33848 22.075 9.52598 21.775 9.52598 21.5125C9.52598 21.275 9.51348 20.4875 9.51348 19.65C7.00098 20.1125 6.35098 19.0375 6.15098 18.475C6.03848 18.1875 5.55098 17.3 5.12598 17.0625C4.77598 16.875 4.27598 16.4125 5.11348 16.4C5.90098 16.3875 6.46348 17.125 6.65098 17.425C7.55098 18.9375 8.98848 18.5125 9.56348 18.25C9.65098 17.6 9.91348 17.1625 10.201 16.9125C7.97598 16.6625 5.65098 15.8 5.65098 11.975C5.65098 10.8875 6.03848 9.9875 6.67598 9.2875C6.57598 9.0375 6.22598 8.0125 6.77598 6.6375C6.77598 6.6375 7.61348 6.375 9.52598 7.6625C10.326 7.4375 11.176 7.325 12.026 7.325C12.876 7.325 13.726 7.4375 14.526 7.6625C16.4385 6.3625 17.276 6.6375 17.276 6.6375C17.826 8.0125 17.476 9.0375 17.376 9.2875C18.0135 9.9875 18.401 10.875 18.401 11.975C18.401 15.8125 16.0635 16.6625 13.8385 16.9125C14.201 17.225 14.5135 17.825 14.5135 18.7625C14.5135 20.1 14.501 21.175 14.501 21.5125C14.501 21.775 14.6885 22.0875 15.1885 21.9875C19.259 20.6133 21.9999 16.7963 22.001 12.5C22.001 6.975 17.526 2.5 12.001 2.5Z" fill="#8F8F92" />
																	</svg>
																	View on Github
