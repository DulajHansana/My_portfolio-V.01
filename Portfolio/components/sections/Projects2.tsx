												...
												<div className="p-lg-5 p-md-4 p-3 border border-1 mt-5 bg-3">
													<div className="row">
                                                        ...
                                                        <div className="col-lg-5">
                                                            ...
                                                            >
                                                                <SwiperSlide>
                                                                    <img className="w-100" src="assets/imgs/home-page-2/projects/20.png" alt="Project Image 1" />
                                                                </SwiperSlide>
                                                                <SwiperSlide>
                                                                    <img className="w-100" src="assets/imgs/home-page-2/projects/21.png" alt="Project Image 2" />
                                                                </SwiperSlide>
                                                                <SwiperSlide>
