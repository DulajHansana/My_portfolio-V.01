                    ...
                    <div className="rounded-3 border border-1 position-relative overflow-hidden">
                        <div className="box-linear-animation position-relative z-1">
                            <div className="p-lg-8 p-md-6 p-3 position-relative z-1">
                                ...
                                <h3>Achieved Certificate and Badges</h3>
                                                ...
                                                <div className="p-lg-5 p-md-4 p-3 border border-1 mt-5 bg-3">
                                                    <div className="row">
                                                        ...
                                                        <div className="col-lg-5">
                                                            ...
                                                            >
                                                                <SwiperSlide>
                                                                    <img className="w-100" src="assets/imgs/home-page-2/projects/img-1.png" alt="Image 1" />
                                                                </SwiperSlide>
                                                                <SwiperSlide>
                                                                    <img className="w-100" src="assets/imgs/home-page-2/projects/img-2.png" alt="Image 2" />
                                                                </SwiperSlide>
                                                                <SwiperSlide>
                                                                    <img className="w-100" src="assets/imgs/home-page-2/projects/img-3.png" alt="Image 3" />
                                                                </SwiperSlide>
                                                            </Swiper>
                                                            <div className="swiper-button-prev-image shadow position-relative"></div>
                                                            <div className="swiper-button-next-image shadow position-relative"></div>
                                                        </div>
